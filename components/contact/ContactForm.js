  ...
  return (
    <div className='flex flex-col gap-4 max-w-md m-auto'>
      <div className='flex flex-col gap-1'>
        ...
        <input className='p-3 border border-gray-400 rounded-md' type="text" name="name" id="name" />
      </div>
      <div className='flex flex-col gap-1'>

        <span className='text-white font-[400] text-[18px]'>Email</span>
        <input className='p-3 border border-gray-400 rounded-md' type="email" name="email" id="email" />
      </div>
      <div className='flex flex-col gap-1'>

        <span className='text-white font-[400] text-[18px]'>Phone</span>
        <input className='p-3 border border-gray-400 rounded-md' type="number" name="phone" id="phone" />
      </div>
      <div className='flex flex-col gap-1'>

        <span className='text-white font-[400] text-[18px]'>Enter Message</span>
        <input className='p-3 border h-[150px] border-gray-400 rounded-md' type="text" name="message" id="message" multiple />
      </div>
