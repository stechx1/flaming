...
function SuccessModal({ isModalOpen, handleOk }) {
  return (
    <div>
      <Modal
        onCancel={handleOk}
        ...
        <div className="border-b-2 my-4 py-3">
          ...
          <div>
            <p className="text-xl font-semibold text-center my-3 text-green-600">
              Your resquest has been sent successfully
            </p>
            <p className="text-lg font-medium text-center my-3">You will soon receive an email about sample product</p>
