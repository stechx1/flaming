...
export default function Navbar() {
  ...
  const navigation = [
    ...
    {
      name: 'About',
      current: router.pathname === '/about-us' ? true : false,
      path: '/about-us',
    },
    {
      name: 'Reviews',
      current: router.pathname === '/customer-reviews' ? true : false,
    ...
    {
      name: 'Contact',
      current: router.pathname === '/contact-us' ? true : false,
      path: '/contact-us',
    },
    {
      name: 'Design Your Sign or Box',
      current: router.pathname === '/design-your-sign-or-box' ? true : false,
      path: '/',
    },
    {
      name: 'Customer',
      current: router.pathname === '/page_for_admin' ? true : false,
      path: '/page_for_admin',
    },
  ];
  const navItem = token
    ? navigation
    : navigation.filter((item) => item.path !== '/page_for_admin');
  return (
